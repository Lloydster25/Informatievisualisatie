...
df1 = pd.read_csv('databases/human_development.csv')
df1 = df1[['Country','Human Development Index (HDI)']]
df2 = pd.read_csv('databases/gender_development.csv')
df2 = df2[['Country','Gender Development Index (GDI)']]
df3 = pd.read_csv('databases/suiciderateall.csv')
...
merge.to_csv('databases/IV DATASET 1.csv', index=False)
